                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user['email'] }}</td>
                                        <td>
                                            <a href="{{ $user['submission'] == null ? "#" : asset('DesignPoster/'.$user['submission']) }}" target="_blank">
                        ...
                        <div class="tab-content" id="participants_tab_content">
                            ...
                            <div class="tab-pane fade show active" id="pills_participant1" role="tabpanel" aria-labelledby="pills_participant1-tab" tabindex="0">
                                <div>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="detail_institution1">Institution</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="institution1" class="form-control" id="detail_institution1" readonly required/>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade show" id="pills_participant2" role="tabpanel" aria-labelledby="pills_participant2-tab" tabindex="0">
                                <div>
                                    <div class="row mb-3">
                                     ...
                                     <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="detail_institution2">Institution</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="institution2" class="form-control" id="detail_institution2" readonly required/>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade show" id="pills_participant3" role="tabpanel" aria-labelledby="pills_participant3-tab" tabindex="0">
                                <div>
                                    <div class="row mb-3">
                                     ...
                                     <div class="row mb-3">
                                        <label class="col-sm-2 col-form-label" for="detail_institution3">Institution</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="institution3" class="form-control" id="detail_institution3" readonly required/>
                                        </div>
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1200px; width:100%; margin:auto; padding:5%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.design.poster') }}" method="post" autocomplete="off" class="px-4">
                    @csrf
                    <div class="row mb-3">
...
<div class="modal fade" id="delete_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.design.poster') }}" method="post" autocomplete="off">
                    @csrf
                    @method('delete')
                    <div class="row mb-3">
