                        ...
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">
                                    Semangat Admin Essay Competition 🎉
                                </h5>
                                <p class="mb-4">
                            ...
                            <tbody class="table-border-bottom-0">
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user['email'] }}</td>
                                        <td>
                                            <a href="{{ $user['submission'] == null ? "#" : asset('EssayCompe/'.$user['submission']) }}" target="_blank">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1200px; width:100%; margin:auto; padding:5%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.essay.compe') }}" method="post" autocomplete="off" class="px-4">
                    @csrf
                    <div class="row mb-3">
...
<div class="modal fade" id="delete_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.essay.compe') }}" method="post" autocomplete="off">
                    @csrf
                    @method('delete')
                    <div class="row mb-3">
