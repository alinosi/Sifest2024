                        ...
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">
                                    Semangat Admin Seminar VIP 🎉
                                </h5>
                                <p class="mb-4">
                                    <span class="fw-bold text-primary fs-2">{{ $users->where("metode", "Online")->count() }}</span> tiket telah terjual secara online
                                </p>
                                <p class="mb-4">
                                    <span class="fw-bold text-primary fs-2">{{ $users->where("metode", "Marketing")->count() }}</span> tiket telah terjual oleh marketing
                                </p>
...
<div class="modal fade" id="insertModal" tabindex="-1" aria-labelledby="insertModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Seminar VIP Manual Registration</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="{{ route('registrationOTS.tiket') }}" method="post" autocomplete="off">
                @csrf
                <input type="text" name="metode" value="Marketing" class="form-control" id="metode" hidden/>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1200px; width:100%; margin:auto; padding:5%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('admin.tiket') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row mb-3">
