    ...
    <div class="wrapper">
        ...
        <div class="container p_relative py20">
            <div class="title_font text_center mt20 mb12">
                <p class="text_big fc_white">Essay Competition Registration</p>
            ...
            <div class="form_wrapper_grid box_lt_rb_side p6" style="max-width: 1000px; margin:auto">
                ...
                <form action="{{ route('registration.essay.compe') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form_group">
                            ...
                            <div class="input_wrapper">
                                <div class="input_radio_uiux">
                                    ...
                                    <input id="3_persons" checked type="radio" class="participants_poster" name="participants_poster" value="3">
                                    <label for="3_persons" class="radio_btn">3 Persons</label>
                                    
                                    <input id="2_persons" type="radio" class="participants_poster" name="participants_poster" value="2">
                                    <label for="2_persons" class="radio_btn">2 Persons</label> 
                                    
                                    <input id="1_persons" type="radio" class="participants_poster" name="participants_poster" value="1">
                                ...
                                <div class="form_tab" data-content="3">
                                            ...
                                            <div class="input_container">
                                                ...
                                                <div class="input_div">
                                                    ...
                                                    <input type="text" name="name3" id="name3"
                                                        value="{{ old('name3') }}" class="input" required>
                                                </div>
                                            </div>
                                            @error('name3')
                                                <div class="error_msg">
                                            ...
                                            <div class="input_container">
                                                ...
                                                <div class="input_div">
                                                    ...
                                                    <input type="tel" pattern="62\d+" minlength="11" maxlength="15"
                                                        name="phone_number3" id="phone_number3"
                                                        class="input phone_number" value="{{ old('phone_number3') }}"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="error_msg">
                                            ...
                                            <div class="input_container">
                                                ...
                                                <div class="input_div">
                                                    ...
                                                    <input type="text" name="line3" id="line3"
                                                        value="{{ old('line3') }}" class="input" required>
                                                </div>
                                            </div>
                                            @error('line3')
                                                <div class="error_msg">
                                        ...
                                        <div class="input_wrapper">
                                            <div class="input_container">
                                                ...
                                                <div class="input_div">
                                                    <p class="input_title title_font">Institution</p>
                                                    <input type="text" name="institution3" id="institution3"
                                                        value="{{ old('institution3') }}" class="input" required>
                                                </div>
                                            </div>
                                            <div class="error_msg">
                                                <p class="text_xsm fc_bluegly">
                                        ...
                                        <div class="input_wrapper">
                                            <div class="input_container focus">
                                                ...
                                                <div class="input_div">
                                                    <p class="input_title title_font">ID card/Identifier</p>
                                                    <input type="file" accept="image/*" name="idcard3" id="idcard3"
                                                        value="" required>
                                                </div>
                                            </div>
                                            @error('idcard3')
                        ...
                        <div class="form_group">
                            ...
                            <div class="input_wrapper">
                                <div class="input_info mb6">
                                    <p class="fc_white">
                                        Calon peserta dikenakan fee registrasi sebesar <span class="fc_bluegly fw_bold">Rp35.000 (Individual/Team)</span>, peserta dapat melakukan proses pembayaran melalui beberapa opsi :
                                ...
                                <label for="verify_data" class="d_flex mt4">
                                    ...
                                    <span class="text_sm ml2 fc_white">Saya menyatakan bahwa bukti pembayaran dan data yang saya kirim adalah benar dan tanpa rekayasa.</span>
                                </label>
                            </div>
