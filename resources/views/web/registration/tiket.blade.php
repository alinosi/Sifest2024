    ...
    <div class="wrapper">
        ...
        <div class="container p_relative py20">
            <div class="title_font text_center mt20 mb12">
                <p class="text_big">Tiket Registration</p>
            ...
            <div class="form_wrapper_grid box_lt_rb_side p6" style="max-width: 1000px; margin:auto">
                ...
                <div class="type_navs d-flex content_center py4" id="type_navs">
                    ...
                    <!--</button> -->
                    <button class="type_nav px8 {{ $slot['supernova'] == 0 ? "" : "active" }}" data-id="2" {{ $slot['supernova'] == 0 ? "Disabled" : "" }}>
                ...
                <div class="type_tabs">
                    ...
                    <!--    <form action="{{ route("registration.tiket") }}" method="post" autocomplete="off" enctype="multipart/form-data">-->
                    <!--        @csrf-->
                    ...
                    <!--                        <p class="fc_bluegly title_font mt3">3 Ticket = <span class="fc_white">RP 180.000</span></p>-->
                    <!--                        <p class="fc_bluegly title_font mt3">4 Ticket = <span class="fc_white">RP 240.000</span></p>-->
                    <!--                        <p class="fc_bluegly title_font mt3">5 Ticket = <span class="fc_white">RP 300.000</span></p>-->
                    <!--                    </div> -->
                    <!--                    <div class="price_list mt3">-->
                    <!--                        <p class="fc_blue title_font input_title">Price List - Normal</p>-->
                    <!--                        <p class="fc_bluegly title_font mt3">1 Ticket = <span class="fc_white">RP 70.000</span></p>-->
                    <!--                        <p class="fc_bluegly title_font mt3">2 Ticket = <span class="fc_white">RP 140.000</span></p>-->
                    <!--                        <p class="fc_bluegly title_font mt3">3 Ticket = <span class="fc_white">RP 195.000</span> ( 15k off )</p>-->
                    <!--                        <p class="fc_bluegly title_font mt3">4 Ticket = <span class="fc_white">RP 280.000</span></p>-->
                    <!--                        <p class="fc_bluegly title_font mt3">5 Ticket = <span class="fc_white">RP 310.000</span> ( 40k off )</p>-->
                    <!--                    </div>-->
                    ...
                    <!--                                <li>Mandiri <span class="fc_bluegly fw_bold">1120019491013 </span> a.n. Dzakiyya Nur Fadhila</li>-->
                    <!--                                <li>Ovo/Dana <span class="fc_bluegly fw_bold">081373626361 </span> a.n. Dzakiyya Nur Fadhila</li>-->
                    <!--                            </ul>-->
                    <!--                        </p>-->
                    <!--                    </div>-->
                    ...
                    <div class="type_tab {{ $slot['supernova'] == 0 ? "" : "active" }}" type-content="1">
                        <!--<form action="{{ route("registration.tiket") }}" method="post" autocomplete="off" enctype="multipart/form-data">-->
                        <form action="{{ route("registration.tiket") }}" method="post" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <div class="form_container seminar pb2">
                ...
                <!--                    <div class="price_list mt3">-->
                <!--                        <p class="fc_blue title_font input_title">Price List - Normal</p>-->
                <!--                        <p class="fc_bluegly title_font mt3">1 Ticket = <span class="fc_white"> RP 85.000</span></p>-->
                <!--                    </div>-->
