...
@section('index')
    <section class="form_section register_uiux">
        <div class="wrapper">
            ...
            <div class="container p_relative py20">
                <div class="title_font text_center mt20 mb12">
                    <p class="text_big fc_white">UIUX Registration</p>
                ...
                <div class="form_wrapper_grid box_lt_rb_side p6" style="max-width: 1000px; margin:auto">
                    ...
                    <form action="{{ route('registration.uiux.design') }}" method="post" autocomplete="off"
                            ...
                            <div class="form_group">
                                ...
                                <div class="input_wrapper">
                                    <div class="input_radio_uiux">
                                        <input id="3_persons" checked type="radio" class="participants"
                                            name="participants" value="3">
                                        <label for="3_persons" class="radio_btn">3 Persons</label>
                                        
                                        <input id="2_persons" type="radio" class="participants" name="participants"
                                            value="2">
                            ...
                            <div class="form_group">
                                    ...
                                    <div class="input_container">
                                        ...
                                        <div class="input_div">
                                            ...
                                            <input type="text" name="team_name" id="team_name"
                                                value="{{ old('team_name') }}" class="input" required>
                                        </div>
                                    </div>
                                    @error('team_name')
                                        <div class="error_msg">
                                ...
                                <div class="input_wrapper">
                                    <div class="input_info mb6">
                                        <p class="fc_white">
                                            Calon peserta dikenakan fee registrasi sebesar <span class="fc_bluegly fw_bold">Rp55.000/Team
</span>, peserta dapat melakukan proses pembayaran melalui beberapa
                                            opsi :
                                        <ul style="list-style: circle !important" class="ml4 fc_white">
                                            ...
                                            <li>GOPAY/DANA <span class="fc_bluegly fw_bold">081369016729 </span> Merizka Azzahra</li>
