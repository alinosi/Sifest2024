    ...
    <div class="wrapper">
        ...
        <div class="container p_relative py20">
            <div class="title_font text_center mt20 mb12">
                ...
                <p class="fc_red">Essay Competition</p>
            </div>
            <div class="form_wrapper box_lt_rb_side p6">
                <i class="box_lt_rb_side_design"></i>
                <!--<form action="{{ route("submission.essay.compe") }}" method="post" autocomplete="off" enctype="multipart/form-data">-->
                <!--    @csrf-->
                ...
                <!--                        <b>ESAISIFEST_Nama Peserta / Ketua Tim(jika dalam bentuk kelompok)_ judul karya</b>-->
                <!--                    </p>-->
                <!--                </div>-->
                <!--            </div>-->
                <!--        </div>-->
                ...
                <!--        <a href="{{ asset('EssayCompe/'.$user['submission']) }}" class="fw_bold fc_red" target="_blank" style="text-decoration: underline !important">{{ $user['submission'] }}</a>-->
                <!--    @endif-->
                <!--</form>-->
            </div>
        </div>
