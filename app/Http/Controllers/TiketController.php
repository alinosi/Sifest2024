...
class TiketController extends Controller
{
    ...
    private $preNebulaMax = 0;
    private $NebulaMax = 0;
    private $preSupernovaMax = 0;
    ...
    public function index()
    {
        ...
        return view("web/tiket/tiket", $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $user = Tiket::where('email', Auth::user()->email)->first();
        $count_user_nebula = Tiket::where('type', "Nebula")->count() - $this->preNebulaMax;
        $count_user_supernova = Tiket::where('type', "Supernova")->count() - $this->preSupernovaMax;
        ...
        return view("web/registration/tiket", $data);
    ...
    public function registrationOTS (Request $request)
    {
        ...
        $Tiket = new Tiket($validation);
        $Tiket->save();
        return redirect()->intended('/sifest2024/admin/tiket')->with("success", "Registration is successful");
    }
}
